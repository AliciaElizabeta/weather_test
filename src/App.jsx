...
function App() {
  ...
  return (
    <div className="p-4">
      <h2 className="text-xl font-bold mb-4">Mapa de España por comunidades</h2>
      <ComposableMap
        projection="geoMercator"
        projectionConfig={{ scale: 1500, center: [-3, 40] }}
        width={600}
        height={700}
      >
